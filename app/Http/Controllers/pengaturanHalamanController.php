...
class pengaturanHalamanController extends Controller
{
    function index()
    {
        $datahalaman = halaman::orderBy('nama', 'asc')->get();
        return view("dasboard.pengaturan.index")->with('datahalaman', $datahalaman);
    }
    function update(Request $request)
    {
        ...
        return redirect()->route('pengaturan.index')->with('success', 'Berhasil update data pengaturan halaman');
    }
}
